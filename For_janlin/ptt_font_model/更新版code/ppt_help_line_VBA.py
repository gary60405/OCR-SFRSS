...
def getlableSize(text, font, size, underline=False, strikeout=False, Italic=False, Bold=False, Shadow=False):  # 計算字體大小
    tempdc = 0
    tempbmp = 0
    f = 0
    lf = LOGFONT()
...
def tiffcreate(filename="test", font="kaiu", underline=False, strikeout=False, Italic=False, Bold=False, Shadow=False, textlinevis=False, textlinecolor=RGB(0, 0, 0), textfillcolor=RGB(0, 0, 0)):
    ...
    for chr in testchr:
        ...
        if currentx+cx+12 >= PPTpresentation.PageSetup.SlideWidth:
            # 紀錄該行座標軸
            box.append("WordStr {} {} {} {} {} #{}".format(int(round(basicx*xmut)), maxheight-(int(round((currenty+maxcy)*ymut))),
                                                           int(round((currentx)*xmut)), maxheight-int(round(currenty*ymut)), currentslide-1, currentline))
            # 生成空格座標軸
            box.append("{} {} {} {} {} {}".format('\t', int(round((currentx)*xmut)), maxheight-(int(round((currenty+maxcy)*ymut))),
                                                  int(round((currentx)*xmut))+10, maxheight-int(round(currenty*ymut)), currentslide-1))
            # 初始化 並換行
            currentx = basicx
            tempx = currentx
        ...
        xmut = xmut + xadd
        currentline = currentline + "{} ".format(chr)
        maxcy = max(maxcy, cy)
...
tiffcreate(filename="line_kaiu")
tiffcreate(filename="line_kaiu_bold", font="kaiu", Bold=True)
tiffcreate(filename="line_kaiu_Shadow", font="kaiu", Shadow=True)
tiffcreate(filename="line_kaiu_Italic", font="kaiu", Italic=True)
tiffcreate(filename="line_kaiu_strikeout", font="kaiu", strikeout=1)
tiffcreate(filename="line_kaiu_underline", font="kaiu", underline=True)
tiffcreate(filename="line_kaiu_bold_shadow_tlblack_tfwhite", font="kaiu", Bold=True,
           Shadow=True, textlinevis=True, textlinecolor=RGB(0, 0, 0), textfillcolor=RGB(255, 255, 255))
tiffcreate(filename="line_kaiu_bold_shadow_tlwhite", font="kaiu", Bold=True,
           Shadow=True, textlinevis=True, textlinecolor=RGB(255, 255, 255))


tiffcreate(filename="line_Microsoft JhengHei")
tiffcreate(filename="line_Microsoft JhengHei_bold",
           font="Microsoft JhengHei", Bold=True,)
tiffcreate(filename="line_Microsoft JhengHei_Shadow",
           font="Microsoft JhengHei", Shadow=True)
tiffcreate(filename="line_Microsoft JhengHei_Italic",
           font="Microsoft JhengHei", Italic=True)
tiffcreate(filename="line_Microsoft JhengHei_strikeout",
           font="Microsoft JhengHei", strikeout=1)
tiffcreate(filename="line_Microsoft JhengHei_underline",
           font="Microsoft JhengHei", underline=True)
tiffcreate(filename="line_Microsoft JhengHei_bold_shadow_tlblack_tfwhite", font="Microsoft JhengHei", Bold=True,
           Shadow=True, textlinevis=True, textlinecolor=RGB(0, 0, 0), textfillcolor=RGB(255, 255, 255))
tiffcreate(filename="line_Microsoft JhengHei_bold_shadow_tlwhite", font="Microsoft JhengHei", Bold=True,
           Shadow=True, textlinevis=True, textlinecolor=RGB(255, 255, 255))


tiffcreate(filename="line_Microsoft YaHei")
tiffcreate(filename="line_Microsoft YaHei_bold",
           font="Microsoft YaHei", Bold=True,)
tiffcreate(filename="line_Microsoft YaHei_Shadow",
           font="Microsoft YaHei", Shadow=True)
tiffcreate(filename="line_Microsoft YaHei_Italic",
           font="Microsoft YaHei", Italic=True)
tiffcreate(filename="line_Microsoft YaHei_strikeout",
           font="Microsoft YaHei", strikeout=1)
tiffcreate(filename="line_Microsoft YaHei_underline",
           font="Microsoft YaHei", underline=True)
tiffcreate(filename="line_Microsoft YaHei_bold_shadow_tlblack_tfwhite", font="Microsoft YaHei", Bold=True,
           Shadow=True, textlinevis=True, textlinecolor=RGB(0, 0, 0), textfillcolor=RGB(255, 255, 255))
tiffcreate(filename="line_Microsoft YaHei_bold_shadow_tlwhite", font="Microsoft YaHei", Bold=True,
           Shadow=True, textlinevis=True, textlinecolor=RGB(255, 255, 255))

tiffcreate(filename="line_PMingLiU")
tiffcreate(filename="line_PMingLiU_bold", font="PMingLiU", Bold=True,)
tiffcreate(filename="line_PMingLiU_Shadow", font="PMingLiU", Shadow=True)
tiffcreate(filename="line_PMingLiU_Italic", font="PMingLiU", Italic=True)
tiffcreate(filename="line_PMingLiU_strikeout", font="PMingLiU", strikeout=1)
tiffcreate(filename="line_PMingLiU_underline", font="PMingLiU", underline=True)
tiffcreate(filename="line_PMingLiU_bold_shadow_tlblack_tfwhite", font="PMingLiU", Bold=True,
           Shadow=True, textlinevis=True, textlinecolor=RGB(0, 0, 0), textfillcolor=RGB(255, 255, 255))
tiffcreate(filename="line_PMingLiU_bold_shadow_tlwhite", font="PMingLiU", Bold=True,
           Shadow=True, textlinevis=True, textlinecolor=RGB(255, 255, 255))
